...
//                JProgramInfo->class12[p_i].day_pos_p[3], p_i);
            ...
            if (JProgramInfo->class23[sum_i].allist[mmm].cal_flag == 0) {
                for (int i = 0; i < 4; i++) {
                    JProgramInfo->class23[sum_i].DayP[i] += JProgramInfo->class12[p_i].day_pos_p[i];
                    JProgramInfo->class23[sum_i].DayQ[i] += JProgramInfo->class12[p_i].day_pos_q[i];
                    JProgramInfo->class23[sum_i].MonthP[i] += JProgramInfo->class12[p_i].mon_pos_p[i];
