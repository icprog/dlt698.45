...
void AddCjiFangAnInfo(INT8U *data, Action_result *act_ret) {
    ...
    for (k = 0; k < addnum; k++) {
        ...
        fprintf(stderr, "\n存储时标选择 ： %d (1:任务开始时间  2：相对当日0点0分  3:相对上日23点59分  4:相对上日0点0分  5:相对当月1日0点0分)",
                fangAn.savetimeflag);
        fprintf(stderr, "\n");
//		if(readCoverClass(0x6015,fangAn.sernum,&para6015,sizeof(CLASS_6015),coll_para_save)== 1) {
//			if(memcmp(&para6015,&fangAn,sizoeof(CLASS_6015))==0) {
//
//			}
//		}
