 ...
 * 湖南主站升级机制：
 * 1、将要升级的终端的主IP修改为1.6.0.**,  主IP端口改为4136（每台前置机的端口不一样）
...
//				act_ret->datalen = 1;
        ...
        case 0xF202:	//红外
        	...
        	break;
        case 0xF205:
        	act_ret->datalen = f205_act127(oad,data,&act_ret->DAR);
        	break;
        case 0xF207:
        	act_ret->datalen = f207_act127(oad,data,&act_ret->DAR);
        	break;
        case 0xF209:
...
//        case 0x2408:
        ...
        case 0x2307:
        case 0x2308:
        	class23_selector(oad, data, act_ret);
            break;
        case 0x8000:
