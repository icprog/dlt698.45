...
SecureUnit DefaultSecurePara[]={{{0x0FFF,0x8004},3},//当前电量
														...
														{{0x400A,0x4300},0},//两套分时费率切换时间
														{{0x400B,0x4300},0},//两套阶梯切换时间
														{{0x401C,0x4300},0},//电流互感器变比
														{{0x401D,0x4300},0},//电压互感器变比
														{{0x401E,0x4300},0},//金额限值
														{{0x4018,0x4000},0},//当前套费率电价
														{{0x4019,0x4300},0},//备用套费率电价
														{{0x401A,0x4000},0},//当前套阶梯参数
														{{0x401B,0x4300},0},//备用套阶梯参数
														{{0x4111,0x8104},0},//备案号
														{{0x4FFF,0x4110},3},//参变量
