...
static VERINFO verinfo_HuNan    = { "QDGK", "SXY8", "171227", "1.10", "160328", "00000000" }; // 4300 版本信息
static VERINFO verinfo_ZheJiang  = { "QDGK", "V1.1", "171225", "1.10", "160328", "00000000" }; // 4300 版本信息
...
void InitClass4300() //电气设备信息
{
	...
	}else if(getZone("ZheJiang")==0) {
		memcpy(&run_version,&verinfo_ZheJiang,sizeof(VERINFO));
	}else {
