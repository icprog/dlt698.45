...
void InIt_Process(int argc, char *argv[])
{
	...
	if(argc==3) {	//para
		...
		case 4:		//恢复出厂参数
			...
			paraInit(0,NULL);
        	//参数初始化将相应的变位标志置位
			JProgramInfo->oi_changed.oi6000++;
			JProgramInfo->oi_changed.oi6012++;
			JProgramInfo->oi_changed.oi6014++;
			JProgramInfo->oi_changed.oi4016++;
			JProgramInfo->oi_changed.oiF203++;
			JProgramInfo->oi_changed.oi4300++;
			JProgramInfo->oi_changed.oi4500++;
			JProgramInfo->oi_changed.oi4510++;
