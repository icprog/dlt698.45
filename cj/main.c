...
static char
		*usage_coll =
					...
					"[采集档案配置表读取]cj coll pro 0x6000	\n"					\
					"[任务配置单元] cj coll pro 0x6013 <任务号> [读取任务配置单元]\n" 		\
					"			  cj coll pro 0x6013 任务ID 执行频率 方案类型 方案编号 开始时间 结束时间 延时 执行优先级 状态 运行时段 起始小时:起始分钟 结束小时:结束分钟\n"	\
					"             cj coll pro 0x6013 1 1-5 1 1 2016-11-11 0:0:0 2099-9-9 9:9:9 1-2 2 1 0 0:0-23:59\n" 		\
					"[普通采集方案] cj coll pro 0x6015 <采集方案号>\n" 		\
					"-------------------------------------------------------\n\n"	\
					;
static char
		*usage_event =
