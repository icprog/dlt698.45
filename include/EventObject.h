...
typedef struct
{
	...
	Event300F_Object Event300F_obj; //电压相序异常
	Event3010_Object Event3010_obj; //电流相序异常
...
const static EVENT_CLASS_INFO  event_class_len[] ={
		...
		{0x301B,sizeof(Class7_Object)},     {0x300F,sizeof(Event300F_Object)},  {0x3010,sizeof(Event3010_Object)}
};
...
const static event_guanlian guanlian_oad[]={
		{0x3106,6,{{0x2022,0x02,0x00},{0x201e,0x02,0x00},{0x2020,0x02,0x00},{0x2024,0x02,0x00},{0x3300,0x02,0x00},{0x3309,0x02,0x06}}},
		...
		{0x3118,6,{{0x2022,0x02,0x00},{0x201e,0x02,0x00},{0x2020,0x02,0x00},{0x2024,0x02,0x00},{0x3300,0x02,0x00},{0x3302,0x02,0x06}}},
		...
		{0x311B,7,{{0x2022,0x02,0x00},{0x201e,0x02,0x00},{0x2020,0x02,0x00},{0x2024,0x02,0x00},{0x3300,0x02,0x00},{0x330D,0x06,0x00},{0x330D,0x07,0x00}}},
		...
		{0x300F,5,{{0x2022,0x02,0x00},{0x201e,0x02,0x00},{0x2020,0x02,0x00},{0x2024,0x02,0x00},{0x3300,0x02,0x00}}},
		{0x3010,5,{{0x2022,0x02,0x00},{0x201e,0x02,0x00},{0x2020,0x02,0x00},{0x2024,0x02,0x00},{0x3300,0x02,0x00}}}
};
#endif
